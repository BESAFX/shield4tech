...
import com.besafx.app.service.hr.EmployeeService;
...
public class EmployeeRest {
    ...
    @PreAuthorize("hasRole('ROLE_EMPLOYEE_UPDATE')")
    @Transactional
    public String setGUILang(@PathVariable(value = "employeeId") Long employeeId, @PathVariable(value = "lang") String lang) {
    ...
    @PreAuthorize("hasRole('ROLE_EMPLOYEE_UPDATE')")
    @Transactional
    public String setDateType(@PathVariable(value = "employeeId") Long employeeId, @PathVariable(value = "type") String type) {
        Employee employee = employeeService.findOne(employeeId);
        Options options = JSONConverter.toObject(employee.getPerson().getOptions(), Options.class);
    ...
    @Transactional
    public String enable(@PathVariable(value = "employeeId") Long employeeId) {
        Employee employee = employeeService.findOne(employeeId);
        if (employee != null) {
            employee.getPerson().setEnabled(true);
            employee.getPerson().setTokenExpired(false);
    ...
    @Transactional
    public String disable(@PathVariable(value = "employeeId") Long employeeId) {
        Employee employee = employeeService.findOne(employeeId);
        if (employee != null) {
